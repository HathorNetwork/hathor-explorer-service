...
class TestWalletService:
    ...
    def test_address_history(self, wallet_service_gateway):
        ...
        wallet_service_gateway.address_history.assert_called_once_with(addr, token, limit, offset)
    ...
    def test_address_tokens(self, wallet_service_gateway):
        ...
        assert all([ret == obj for ret, obj in zip(returned['tokens'], expected['tokens'])])
        wallet_service_gateway.address_tokens.assert_called_once_with(addr, limit, offset)
