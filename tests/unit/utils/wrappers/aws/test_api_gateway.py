...
class TestApiGateway:
    ...
    def test_parse_json_fail_proof(self):
        ...
        event = {"body": "bad-json-value", "headers": {}}
    ...
    @patch(
        "utils.wrappers.aws.api_gateway.CORS_ALLOWED_REGEX",
        r"https?://([a-z0-9]*\.){0,5}hathor\.network",
    )
    def test_returning_cors_headers(self):
        function = MagicMock(return_value={"statusCode": 200, "headers": {}})
        api_gateway = ApiGateway()

        event = {"body": "{}", "headers": {"origin": "https://explorer.hathor.network"}}
    ...
    def test_returning_cors_headers_testnet(self):
        ...
        event = {
            "body": "{}",
            "headers": {"origin": "https://explorer.testnet.hathor.network"},
        }
        ...
        assert (
            result["headers"]["Access-Control-Allow-Origin"]
            == r"https://explorer.testnet.hathor.network"
        )
        assert result["headers"]["Access-Control-Allow-Credentials"] is True
    ...
    def test_returning_cors_headers_golf(self):
        ...
        event = {
            "body": "{}",
            "headers": {"origin": "https://explorer.golf.hathor.network"},
        }
    ...
    def test_cors_fail_regex_not_matching(self):
        ...
        event = {
            "body": "{}",
            "headers": {"origin": "https://explorer.anydomain.network"},
        }
