...
class TestNetworkStatisticsApiGateway:
    def setup_method(self):
        ...
        self.network_statistics_api_gateway = NetworkStatisticsApiGateway(self.mock_elastic_search_client)

    def test_init(self):
        assert self.network_statistics_api_gateway.elastic_search_client == self.mock_elastic_search_client
    ...
    def test_get_transaction_statistics(self):
        ...
        assert result == {"total_transactions": 100, "total_custom_tokens": 50, "highest_height": 1000}
