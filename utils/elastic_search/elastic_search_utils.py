...
from utils.elastic_search.transformations.token_api import (
    es_hit_to_result as token_api_es_hit_to_result,
)
from utils.elastic_search.transformations.token_balances import (
    es_hit_to_result as token_balances_es_hit_to_result,
)
from utils.elastic_search.transformations.tx import (
    es_hit_to_result as tx_es_hit_to_result,
)
...
class ElasticSearchUtils:
    ...
    def build_search_query(
        ...
        sort_by_complement = self.get_sort_by_complement(
            sortable_fields=SORTABLE_FIELDS_BY_INDEX[self.elastic_index],
            sort_by=sort_by,
        )
