...
WALLET_SERVICE_USERNAME = config('WALLET_SERVICE_USERNAME', default=None)
WALLET_SERVICE_PASSWORD = config('WALLET_SERVICE_PASSWORD', default=None)
WALLET_SERVICE_HOST = config('WALLET_SERVICE_HOST', default=None)
WALLET_SERVICE_DB = config('WALLET_SERVICE_DB', default=None)
